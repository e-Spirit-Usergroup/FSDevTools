...
@Examples(
        examples = {
                "fs-cli -h localhost -p 8000 groovyscript run --scriptURI myscript.groovy --scriptParameters '{}'",
                "fs-cli -h localhost -p 8000 groovyscript run --scriptURI file:///myproject/lib/src/main/groovy/myscript.groovy --scriptParameters '{}'",
                "fs-cli -h localhost -p 8000 groovyscript run --scriptURI file:///myproject/lib/src/main/groovy/myscript.groovy --scriptParameters \"$(./jq -c '.' < scriptparameters.json)\""
        },
        descriptions = {
                ...
                "Runs given \"myscript.groovy\" scriptfile.\n" +
                        ...
                        "\t\tfsContext : class ScriptContext\n" +
                        "\t\tscriptParameters : class Map<String, Object>",
                "Runs given \"myscript.groovy\" scriptfile. Using library 'jq' to read in and escape the json as string for the scriptParameters.\n" +
                        "\tcontext variables:\n" +
                        "\t\tfsConnection : class de.espirit.firstspirit.access.Connection\n" +
                        "\t\tfsContext : class ScriptContext\n" +
                        "\t\tscriptParameters : class Map<String, Object>"
